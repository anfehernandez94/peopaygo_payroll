...
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">{{ __('Create Timesheet') }}</div>
                ...
                <div class="card-body">
                    <form action="{{ route('timesheet.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="pay_period_init" name="pay_period_init" class="form-control @error('pay_period_init') is-invalid @enderror" value="{{ old('pay_period_init') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="pay_period_end" name="pay_period_end" class="form-control @error('pay_period_end') is-invalid @enderror" value="{{ old('pay_period_end') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="check" name="check" class="form-control @error('check') is-invalid @enderror" value="{{ old('check') }}" required>
                            @error('check')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
